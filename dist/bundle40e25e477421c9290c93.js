...
function createMainDayDiv(leftSideData, middleData, hourlyData, rightSideData) {
  var mainDayDiv = document.createElement("div");
  mainDayDiv.className = "main-day-div";
  mainDayDiv.appendChild(createMainDayLeft(leftSideData));
  mainDayDiv.appendChild(createMainDayMiddle(middleData, hourlyData));
  mainDayDiv.appendChild(createMainDayRight(rightSideData));
  document.body.appendChild(mainDayDiv);
}
function createMainDayLeft(leftSideData) {
  ...
  mainDayLeftGrid.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.createSideContentCard)());
  mainDayLeftGrid.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.createSideContentCard)());
  mainDayLeftGrid.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.createSideContentCard)());
  mainDayLeftGrid.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.createSideContentCard)());
  mainDayLeftGrid.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.createSideContentCard)());
...
function createMainDayMiddle(middleData, hourlyData) {
  ...
  mainDayMiddle.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.mainDayHourly)(hourlyData));
  mainDayMiddle.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.createUnitSlider)());
  return mainDayMiddle;
}
function createMainDayRight(rightSideData) {
  ...
  mainDayRightGrid.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.createSideContentCard)());
  mainDayRightGrid.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.createSideContentCard)());
  mainDayRightGrid.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.createSideContentCard)());
  mainDayRightGrid.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.createSideContentCard)());
  mainDayRightGrid.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.createSideContentCard)());
...
function createRestOfWeek() {
  ...
  for (var i = 0; i < 7; i++) {
    restOfWeekDiv.appendChild((0,_weatherDayCard__WEBPACK_IMPORTED_MODULE_0__.createWeekDayWeatherCard)());
  }
  document.body.appendChild(restOfWeekDiv);
}
function addToBody(leftSideData, middleData, hourlyData, rightSideData, restOfWeekData) {
  createMainDayDiv(leftSideData, middleData, hourlyData, rightSideData);
  createRestOfWeek(restOfWeekData);
}
...
function createHourlyWeatherCard(hourlyData) {
  ...
  temperatureHourly.innerHTML = hourlyData.temp_c;
  var weatherIcon = document.createElement("img");
  weatherIcon.src = _assets_lightRain_png__WEBPACK_IMPORTED_MODULE_0__;
...
function mainDayHourly(hourlyData) {
  ...
  console.log(hourly);
  for (var i = 0; i < 24; i++) {
    hourlyWeather.appendChild(createHourlyWeatherCard(hourly[i]));
  }
...
/* harmony export */   "currentDayForecastData": () => (/* binding */ currentDayForecastData),
/* harmony export */   "forecastAPICall": () => (/* binding */ forecastAPICall),
/* harmony export */   "leftSideData": () => (/* binding */ leftSideData),
/* harmony export */   "locationData": () => (/* binding */ locationData),
/* harmony export */   "middleData": () => (/* binding */ middleData),
/* harmony export */   "restOfWeekData": () => (/* binding */ restOfWeekData),
/* harmony export */   "rightSideData": () => (/* binding */ rightSideData),
/* harmony export */   "weatherAPICall": () => (/* binding */ weatherAPICall),
/* harmony export */   "weatherAPICall2": () => (/* binding */ weatherAPICall2)
/* harmony export */ });
...
function _weatherAPICall() {
  _weatherAPICall = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, weatherData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return fetch("https://api.weatherapi.com/v1/current.json?key=273f0d3a84224f6ba65100946232203&q=Auckland&aqi=yes", {
            mode: "cors"
          });
        case 2:
...
function weatherAPICall2() {
  return _weatherAPICall2.apply(this, arguments);
}
function _weatherAPICall2() {
  _weatherAPICall2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
...
function _forecastAPICall() {
  _forecastAPICall = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var response, weatherForecastData;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return fetch("https://api.weatherapi.com/v1/forecast.json?key=273f0d3a84224f6ba65100946232203&&q=Auckland&days=8&aqi=yes&alerts=no", {
            mode: "cors"
          });
        case 2:
...
function currentDayForecastData() {
  return _currentDayForecastData.apply(this, arguments);
} // async function hourlyDayForecastData() {
//   currentData = currentData.forecast.forecastday[0].hour;
//   return currentData;
// }
function _currentDayForecastData() {
  _currentDayForecastData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var currentData;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return Promise.resolve(forecastAPICall());
        case 2:
          currentData = _context4.sent.forecast.forecastday[0];
          console.log(currentData);
          return _context4.abrupt("return", currentData);
        case 5:
        case "end":
...
function currentData() {
  return _currentData.apply(this, arguments);
}
function _currentData() {
  _currentData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var currentData;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return Promise.resolve(weatherAPICall());
        case 2:
          currentData = _context5.sent.current;
          console.log(currentData);
...
function leftSideData() {
  return _leftSideData.apply(this, arguments);
}
function _leftSideData() {
  _leftSideData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var currentData, leftSideArray;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          return Promise.resolve(weatherAPICall());
        case 2:
          currentData = _context6.sent.current;
          leftSideArray = [];
          leftSideArray.push(currentData.humidity, currentData.pressure_in, currentData.uv, currentData.precip_mm, currentData.wind_kph, currentData.wind_dir);
          return _context6.abrupt("return", leftSideArray);
        case 6:
        case "end":
...
function middleData() {
  return _middleData.apply(this, arguments);
}
function _middleData() {
  _middleData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    var currentData, middleArray;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          return Promise.resolve(weatherAPICall());
        case 2:
          currentData = _context7.sent.current;
          middleArray = [];
          middleArray.push(currentData.temp_c, currentData.condition.text);
          return _context7.abrupt("return", middleArray);
        case 6:
        case "end":
...
function rightSideData() {
  return _rightSideData.apply(this, arguments);
}
function _rightSideData() {
  _rightSideData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
    var currentData, rightSideArray;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          ...
          return Promise.resolve(weatherAPICall());
        case 2:
          currentData = _context8.sent.current.air_quality;
          rightSideArray = [];
          rightSideArray.push(currentData.co, currentData.no2, currentData.so2, currentData.pm2_5, currentData.pm10, currentData["us-epa-index"]);
          return _context8.abrupt("return", rightSideArray);
        case 6:
        case "end":
...
function restOfWeekData() {
  return _restOfWeekData.apply(this, arguments);
}
function _restOfWeekData() {
  _restOfWeekData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
    var currentData, restOfWeekArray;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          return Promise.resolve(weatherAPICall());
        case 2:
          currentData = _context9.sent.current;
          restOfWeekArray = [];
          restOfWeekArray.push();
          return _context9.abrupt("return", restOfWeekArray);
        case 6:
        case "end":
...
function _locationData() {
  _locationData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
    var locationData;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          ...
          return Promise.resolve(weatherAPICall());
        case 2:
          locationData = _context10.sent.location;
...
/******/ })()
;
//# sourceMappingURL=bundle40e25e477421c9290c93.js.map